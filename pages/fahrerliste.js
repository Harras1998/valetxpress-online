              ...
              <form onSubmit={handleLogin} style={{ maxWidth: 420 }}>
                <div style={{ marginBottom: 12 }}>
                  <input
                    ...
                    required
                    onFocus={e=>{if(window.innerWidth<=768){const el=e.currentTarget;el.style.transition="transform 0.2s ease";el.style.transformOrigin="left center";el.style.transform="scale(1.25)";el.style.position="relative";el.style.zIndex="10";el.scrollIntoView({behavior:"smooth",block:"center"});}}} onBlur={e=>{const el=e.currentTarget;el.style.transform="";el.style.zIndex="";el.style.position="";}} style={{
                      width: 260,
                      fontSize: 18,
                      padding: "8px 10px",
                      borderRadius: 4,
